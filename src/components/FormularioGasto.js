...
export const FormularioGasto = ({setModal, hasdleGasto, setGasto, gasto,eliminarGatos}) => {
      ...
      <View style={styles.formulario}>
        ...
        <Pressable style={styles.submitBtn}>
          <Text
            ...
            onPress={() => hasdleGasto({nombre, cantidad, categoria,id ,fecha})}>
